        ...
        <div className="grid lg:grid-cols-2 place-items-center lg:gap-24">
          <div>
            ...
            <p className="text-xl text-muted-foreground mb-8">
              95% milhões de conteúdos são postados diariamente nas redes
              sociais e apenas 0.7% tem bons resultados. A Manycontent pode te
              ajudar a entrar nesse valioso grupo.
            </p>
          </div>
